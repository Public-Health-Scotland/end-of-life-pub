...
![This bar charts shows the QoM measure for each financial year.](figures/figure-1-summary.png) <br>

<div custom-style = "Normal_Notes">
1. Figures for `r latest$fy` are incomplete and will be revised in October `r year(pub_date)` publication.
</div>
