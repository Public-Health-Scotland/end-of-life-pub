...
* In `r max(basefile$fy)`, `r sex_higher`s aged 85 and older spent a higher percentage of their last six months of life in the community (`r if_else(sex_higher == "female", female, male)`%) compared to `r if_else(sex_higher == "female", "male", "female")` (`r if_else(sex_higher == "female", male, female)`%); this equates to `r sex_higher` spending, on average an extra `r as.character(day_diff(female, male))` days in the community in their last six months of life.
