...
<Div custom-style = "Bullet 1">
Looking at the trend in the percentage of time spent at home or in the community in the last six months of life in `r latest$fy` (`r latest$qom`%) was slightly lower than 2020/21 (`r trend$qom[trend$fy=="2020/21"]`%) and 2021/22 (`r trend$qom[trend$fy=="2021/22"]`%) but was higher than before the COVID-19 pandemic.
