...
diff_dir <- if_else(female > male, "higher", "lower")

report_url <- glue("http://www.isdscotland.org/Health-Topics/Health-and-Social-Community-Care/Publications/{pub_date}/{pub_date}-End-of-Life-Report.docx")
...
* In `r max(basefile$fy)`, females aged 85 and older spent a `r diff_dir` percentage of their last six months of life in the community (`r female`%) compared to males (`r male`%); this equates to females spending, on average an extra `r as.character(day_diff(female, male))` days in the community in their last six months of life.
