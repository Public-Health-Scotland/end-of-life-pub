...
1. Figures for `r latest$fy` are provisional`r if_else(pub_type == "provisional", glue(" and will be revised in October {year(pub_date)} publication."), ".")`
</div>
