...
max_sex <- sex %>% filter(qom == max(qom)) %>% pull(sex)
...
![This bar charts shows the QoM measure for each financial year.](figures/figure-1.png) \ <br>
