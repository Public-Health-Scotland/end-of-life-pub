...
<Div custom-style = "Bullet 1">
For people aged 85 and over in `r latest$fy`,  a slightly higher proportion of `r max_sex` spent their last six months of life in the community compared with `r if_else(max_sex == "women", "men", "women")` (`r max(sex$qom)`% and `r min(sex$qom)`%, respectively). This is an average of `r as.character(day_diff(max(sex$qom), min(sex$qom)))` days more for `r max_sex`.
</div>
