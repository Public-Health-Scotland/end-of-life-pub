...
![Map of Scotland split by NHS Board of Residence showing variation in percentage of last six months of life spent at home or in the community for `r latest$fy`. `r max_hb$hb` has the highest percentage of `r max_hb$qom`% and `r min_hb$hb` has the lowest of `r min_hb$qom`%.](figures/figure-2.png)</div>
...
<div custom-style = "Heading 4_pgbrk">
...
<Div custom-style = "Heading 2_nopgbrk">Find out more</div>
...
<div custom-style = "Heading 5_pgbrk">
...
```{r calculations-table, echo = FALSE}
tibble(
  x = c("Actual bed days", 
        "Possible bed days",
...
<div custom-style = "Heading 3_pgbrk">
...
Financial years ending 31st March 2011 - year(pub_date)

**Continuity of data**
Reports include annual data up to latest$fy

**Revisions statement**
All data are revised to ensure the most complete data are presented. Data for most recent financial year are provisional if_else(pub_type == "provisional", glue("and will be updated in the {next_pub_date} publication. "), ". "), "Revisions of this nature are due to incomplete data returns at the time of publication."
...
**Completeness**
SMR01 hospital completeness for the financial year latest$fy is estimated to be comp_scot complete for Scotland. if_else(pub_type == "provisional", glue("and this could have an impact on the time spent in hospital in the last six months of life. "), ". "), comp_metadata, See [Appendix 2](#appendix-2---background-information) for more information and completeness figures for each quarter. Additional information on hospital data completeness  will be made available at the following link: http://www.isdscotland.org/Products-and-Services/Data-Support-and-Monitoring/SMR-Completeness/.

**Comparability**
Due to a small revision in the methodology, figures presented in this publication are not comparable to figures published previously. Trend information from min(basefile$fy) to latest$fy is available in this publication. See [Appendix 3](#appendix-3---methodology) for more information on the revision and its impact.
