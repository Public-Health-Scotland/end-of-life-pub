...
Note that hospital data are provisional for `r latest$fy`. This publication will be updated in October `r year(pub_date)` with final figures. Figures for the latest year should therefore be treated with caution`r if_else(nrow(low_comp) > 0, glue(" particularly for {comp_boards}"), "")`. There could be an undercount of hospital admissions, particularly for people who died in the last three months of the year. See [Appendix 2](#appendix-2---background-information) for more information.
...
This publication will be updated in `r next_pub_date` with final figures.
