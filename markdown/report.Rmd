...
For the `r latest$deaths` residents of Scotland who died in financial year `r latest$fy`, `r latest$qom`% of their last six months of life was spent either at home or in the community (Table 1) and `r latest$qom_hosp`% of their last six months of life was spent in hospital. This is equivalent to each individual spending an average of `r if(latest$hosp < 10){as.character(as.english(latest$hosp))}else{latest$hosp}` days in hospital in the six months prior to their death (Table 1 in the [data tables](`r data_tables`)).
