  ...
  tibble(
    ...
    desc = c("Palliative care is an approach that improves the quality of life of patients and their families facing the problems associated with life-threatening illness. This is achieved through the prevention and relief of suffering by means of early identification and impeccable assessment and treatment of pain and other physical, psychosocial and spiritual problems.",
               ...
               "SIMD- Scottish Index of Multiple Deprivation. Deprivation for individuals is estimated from aggregate data derived from the census and other routine sources. These are used to estimate the deprivation of small geographical areas. Data in this report are analysed by the ‘Scotland level’ Scottish Index of Multiple Deprivation population weighted quintiles. Each quintile consists of approximately 20% of the population living in Scotland, with deprivation quintile 1 indicating the 20% of the population living in the most deprived areas and deprivation quintile 5 the 20% of the population living in the least deprived areas.", 
                ...
                "The Scottish Government Urban/Rural classification can be used to classify geographies as urban, rural or remote. Each data zone is assigned to an urban rural category based upon the location of its population weighted centroid. Further information can be found on the [SG website](http://www.gov.scot/Topics/Statistics/About/Methodology/UrbanRuralClassification).")
  )
```
...
paste0("All data are revised to ensure the most complete data are presented. Data for most recent financial year are provisional", if_else(pub_type == "provisional", glue(" and will be updated in the {next_pub_date} publication. "), ". "), "Revisions of this nature are due to incomplete data returns at the time of publication."),
"",
"",
...
metadata <- tibble(indicator, description)
```
...
Further information and data for this publication are available from the [publication page](https://beta.isdscotland.org/find-publications-and-data/health-and-social-care/social-and-community-care/percentage-of-end-of-life-spent-at-home-or-in-a-community-setting/20-October-2020) on our website.  
...
Data from this publication is available to download from the [NHS Scotland Open Data platform](https://www.opendata.nhs.scot/dataset/palliative-and-end-of-life-care).
...
metadata %>%
  ...
  compose(i = 17, j = 2,
          value = as_paragraph(
            "SMR01 hospital completeness for the financial year ", latest$fy,
            " is estimated to be ", comp_scot, " complete",
            if_else(pub_type == "provisional", glue("and this could have ",
            "an impact on the time spent in hospital in the last six months ",
            "of life. "), ". "), comp_metadata, "See ",
            hyperlink_text(x = "Appendix 2",
                           url = "#appendix-2---background-information",
                           props = fp_text(color = "#6c2c91",
                                           underlined = TRUE,
                                           font.size = 11)),
            " for more information and completeness figures for each quarter. ",
            "Further updates will be made available at the following link: ",
            hyperlink_text(
              x   = paste0("http://www.isdscotland.org/Products-and-Services/",
                           "Data-Support-and-Monitoring/SMR-Completeness/"),
              url = paste0("http://www.isdscotland.org/Products-and-Services/",
                           "Data-Support-and-Monitoring/SMR-Completeness/"),
              props = fp_text(color = "#6c2c91",
                                           underlined = TRUE,
                                           font.size = 11)),
  ...
  compose(i = 14, j = 2,
          value = as_paragraph(
            "Policy concepts: ",
            hyperlink_text(
              x   = paste0("https://www.gov.scot/publications/healthcare-",
                           "quality-strategy-nhsscotland/"),
              url = paste0("https://www.gov.scot/publications/healthcare-",
                           "quality-strategy-nhsscotland/"),
              props = fp_text(color = "#6c2c91",
                                           underlined = TRUE,
                                           font.size = 11)),
            "\n \n",
            hyperlink_text(
              x = "Appendix 2 - Background Information",
              url = "#appendix-2---background-information",
              props = fp_text(color = "#6c2c91",
                                           underlined = TRUE,
                                           font.size = 11)),
            "\n \n",
            hyperlink_text(
              x = "Appendix 3 - Methodology",
              url = "#appendix-3---methodology",
              props = fp_text(color = "#6c2c91",
                                           underlined = TRUE,
                                           font.size = 11))
            )) %>%
  ...
  compose(i = 28, j = 2,
          value = as_paragraph(
            hyperlink_text(
              x = "phs.peolc@phs.scot",
              url = "mailto:phs.peolc@phs.scot",
              props = fp_text(color = "#6c2c91",
                                           underlined = TRUE,
                                           font.size = 11))
            )) %>%
  ...
  compose(i = 18, j = 2,
          value = as_paragraph(
            "Due to a change in methodology, figures presented in this ",
            "publication are not comparable to figures published previously. ",
            "Trend information from ", min(basefile$fy), " to ", 
            latest$fy, " is available in this publication. See ",
            hyperlink_text(
              x = "Appendix 3",
              url = "#appendix-3---methodology",
              props = fp_text(color = "#6c2c91",
                                           underlined = TRUE,
                                           font.size = 11)),
            " for more information on the revision and its impact."
          )) %>%
  
  flextable_style(type = "metadata")
```
