...
The trend in the percentage of the last six months of life spent at home or in a community setting over the past `r as.character(as.english(year(end_date) - year(start_date)))` years for Health and Social Care Partnerships is presented in graphical format in Figure A1.2 (see [List of Tables](#Tables) or [Appendix 1](#appendix-1---trend-data)) and the corresponding data can be found in Table 2 in the [data tables](data_tables). 
