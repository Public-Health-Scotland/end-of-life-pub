...
glossary3 <- c("Bed day", "Unit of measurement relating to an overnight stay in an inpatient hospital bed.")

glossary4 <- c("Time spent in a hospital setting", "Time spent in acute, community or psychiatric hospitals. Refers to all hospital bed days calculated from SMR01 records (acute and geriatric long stay specialties) and SMR04 records (mental health specialties).")

glossary5 <- c("Deprivation (SIMD)", "SIMD- Scottish Index of Multiple Deprivation. 
